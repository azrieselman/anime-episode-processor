...
Current release: **1.0.0-beta2**. See [`CHANGELOG.md`](CHANGELOG.md) for what's in the
box and known limitations.
The `main` branch tracks post-release development after **1.0.0-beta2**.

## Install (end users)

Download the latest `AEP-Setup-1.0.0-beta2.exe` from the
